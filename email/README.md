...
| **1 shared utility** | Multi-account resolution and folder lookup | `email/_email_utils.py` |
 — how to use the tools | `email/EMAIL-AGENT-v1.3.md` (lightweight) |
...
Choose one of the three methods below. The simplest: **load `EMAIL-AGENT-v1.3.md` as your system prompt.**
...
Load `EMAIL-AGENT-v1.3.md` as the **system prompt** in DeepChat. This gives you:
...
**How to load:** Configure DeepChat to use `G:\My Drive\prompts\email\EMAIL-AGENT-v1.3.md` as the system prompt for email sessions.
...
│
├── EMAIL-AGENT-v1.3.md         System prompt (dedicated email sessions)
