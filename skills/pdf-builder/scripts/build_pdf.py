...
v1.1 — 2026-06-03 — Added math rendering via matplotlib mathtext.
...
def render_math_to_image(latex_str, font_size=11, dpi=150):
    ...
    # Clean common LaTeX commands that mathtext handles differently
    expr = latex_str.strip()
    # mathtext uses \text{...} instead of \mathrm{...} in some cases
    # Most standard LaTeX works directly in mathtext
...
def md_to_plain_flowables(text, styles):
    ...
    # Regex-based markdown parsing with math support
    lines = text.split('\n')
    i = 0
    in_code_block = False
