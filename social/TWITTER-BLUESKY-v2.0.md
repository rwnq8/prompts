...
STEP 1.2: Draft main tweet
  ...
  Validate char count less than or equal to 280
...
STEP 2.1: Draft Bluesky post
  ...
  Validate char count less than or equal to 300
...
STEP 2.3: Thread assessment
  ...
  Validate each post less than or equal to 300
...
-  for all character counts and validations
...
- execution fails irrecoverably (character counts unvalidated)
