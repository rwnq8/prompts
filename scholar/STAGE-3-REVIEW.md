...
**RELEASE PUBLISHING RULE:** This stage (Review) does NOT write to `R2 releases (qnfo/releases/)\`. Publication happens ONLY through STAGE-4, which requires explicit user approval. Do not autonomously place files in the releases directory.
